...
image = tk.PhotoImage(file="111.png")
...
open_button = tk.Button(window, text="Open Shortened URL", command=open_shortened_url, bg="#2196f3", fg="white", font=("Helvetica", 12), relief="flat")
